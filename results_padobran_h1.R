...
if (file.exists(file_)) {
  ...
  # load registry----
  # if (interactive()) {
  #   reg = loadRegistry("D:/strategies/h3", work.dir="D:/strategies/h3")
  # } else {
  #   reg = loadRegistry("experiments")
  # }
  reg = loadRegistry("experiments")
  # reg = loadRegistry("D:/strategies/h3/experiments", work.dir="D:/strategies/h3/experiments")
  ...
  # # Save for Luka
  # saveRDS(results, "D:/strategies/h3/results.rds")
